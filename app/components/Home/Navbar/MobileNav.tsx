  ...
  return (
    <div>
      ...
      <div className={`fixed inset-0 ${navOpen} transform transition-all right-0 duration-500 z-[100002] bg-black opacity-60 w-full h-screen`}></div>
        ...
        {/* NavLinks */}
        <div className={`text-black ${navOpen} fixed justify-center flex flex-col h-full transform transition-all duration-500 delay-300 w-[80%] sm:w-[60%] bg-[#F1FAEE] space-y-6 z-[100050] right-0`}>
          {NavLinks.map((link) => {
